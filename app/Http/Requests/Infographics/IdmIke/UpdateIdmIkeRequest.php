...
namespace App\Http\Requests\Infographics\IdmIke;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class UpdateIdmIkeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'indicator_name' => [
                ...
                'string',
                'max:100',
                Rule::unique('infographics_idm_indicator_ike', 'indicator_name')
                    ->ignore($idmIkeId)
            ],
