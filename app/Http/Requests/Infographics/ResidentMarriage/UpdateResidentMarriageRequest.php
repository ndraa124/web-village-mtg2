...
class UpdateResidentMarriageRequest extends FormRequest
{
    ...
    {
        $residentMarriageId = $this->route('residentMarriage')->id;

        return [
            'marriage_id' => [
                'required',
                'integer',
                'exists:m_marriage,id',
                Rule::unique('infographics_resident_marriage', 'marriage_id')->ignore($residentMarriageId),
            ],
