...
namespace App\Http\Requests\Infographics\IdmIks;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class UpdateIdmIksRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'indicator_name' => [
                ...
                'string',
                'max:100',
                Rule::unique('infographics_idm_indicator_iks', 'indicator_name')
                    ->ignore($idmIksId)
            ],
