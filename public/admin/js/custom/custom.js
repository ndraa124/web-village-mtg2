(function () {
    ...
    const getSidebarBurgerMenuCloseId = document.getElementById(
    ...
    if (getPasswordShowHideId) {
        ...
        passwordContainers.forEach((container) => {
            ...
            const passwordToggleIcon = container.querySelector(
    ...
    if (getIconSidebarToggleId) {
        ...
        switchtoggle.addEventListener("click", function () {
            if (
                document.body.getAttribute("icon-sidebar-none-data-theme") ===
    ...
    if (getRightSidebarId) {
        ...
        switchtoggle.addEventListener("click", function () {
            if (
                document.body.getAttribute("right-sidebar-data-theme") ===
    ...
    if (getCardBorderToggleId) {
        ...
        switchtoggle.addEventListener("click", function () {
            if (
                document.body.getAttribute("card-border-data-theme") ===
                "card-border-normal"
            ) {
                document.body.setAttribute(
