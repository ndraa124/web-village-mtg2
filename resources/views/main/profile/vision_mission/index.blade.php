  ...
  <div class="container mx-auto px-4">
    <div class="mb-20">
      <div class="text-center mb-12">
        ...
        <p class="text-gray-600">Cita-cita Menuju Masa Depan Gemilang</p>
    ...
    <div class="mb-20">
      <div class="text-center mb-12">
        ...
        <p class="text-gray-600">Langkah Strategis Mewujudkan Visi</p>
        <p class="text-gray-600">Menggali, memberdayakan serta memaksimalkan semua potensi yang ada di masyarakat</p>
        <div class="w-24 h-1 bg-red-600 mx-auto mt-4"></div>
      </div>
