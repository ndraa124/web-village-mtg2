      ...
      <article class="max-w-none text-gray-700">
        ...
        <div class="flex flex-wrap items-center text-gray-600 text-sm gap-4 mb-6">
          <span>
            ...
            {{ $participate->user->name ?? 'Admin' }}
          </span>
          <span>
            <i class="far fa-calendar mr-2"></i>
            {{ $participate->created_at->format('d F Y') }}
          </span>
          <span>
            <i class="far fa-clock mr-2"></i>
            {{ $participate->created_at->format('H:i') }} WITA
          </span>
        </div>
        ...
        <div class="flex items-center gap-3 mb-6">
          @php
            ...
            $shareTitle = urlencode('Partisipasi Masyarakat - Desa Ati Korupsi Motoling Dua');
        ...
        <div class="fs-16 text-body news-content">
          @if (empty($participate) || $participate->content == '')
