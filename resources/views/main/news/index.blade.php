  ...
  <div class="container mx-auto px-4">
    <div class="flex flex-col lg:flex-row gap-8">
      <div class="lg:w-2/3">
        ...
        @if ($featuredNews)
          <div class="bg-white rounded-3xl shadow-xl overflow-hidden mb-8 transition-all duration-500 hover:shadow-2xl">
            <div class="relative">
        ...
        <div class="grid md:grid-cols-2 gap-6 mb-8">
          @forelse($news as $item)
            <article class="news-card bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500">
          ...
          @empty
            <div class="md:col-span-2 bg-white rounded-3xl shadow-xl p-8 text-center">
