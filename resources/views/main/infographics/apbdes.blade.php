...
<head>
  ...
  <title>Infografis APBDes - Desa Mekarjaya</title>
...
<body class="bg-gray-50">
  ...
  <nav class="bg-white shadow-lg sticky top-0 z-50">
        ...
        <div class="hidden lg:flex items-center space-x-6">
          ...
          <div class="relative group">
            ...
            <div class="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
              ...
              <a href="infografis-apbdes.html" class="block px-4 py-2 text-white bg-red-600">APBDes</a>
    ...
    <div id="mobile-menu" class="lg:hidden hidden bg-white border-t">
      ...
      <div class="px-4 py-2 bg-red-50">
        <p class="font-semibold text-red-700 mb-2">Infografis</p>
        <a href="infografis-penduduk.html" class="block px-8 py-1 text-gray-600 hover:text-red-600">Penduduk</a>
        <a href="infografis-apbdes.html" class="block px-8 py-1 text-red-600 font-semibold">APBDes</a>
        <a href="#" class="block px-8 py-1 text-gray-600 hover:text-red-600">Stunting</a>
        <a href="#" class="block px-8 py-1 text-gray-600 hover:text-red-600">Bansos</a>
        <a href="#" class="block px-8 py-1 text-gray-600 hover:text-red-600">IDM</a>
        <a href="#" class="block px-8 py-1 text-gray-600 hover:text-red-600">SDGs</a>
      </div>
  ...
  <section class="bg-gradient-to-r from-red-600 to-red-800 py-8">
    <div class="container mx-auto px-4">
      <h2 class="text-3xl font-bold text-white mb-2">Infografis APBDes</h2>
      ...
      <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-12 text-center">
          ...
          <p class="text-gray-600 mt-2">
            Memberikan informasi mengenai Anggaran Pendapatan dan Belanja Desa (APBDes) Desa Mekarjaya.
          </p>
        </div>

        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-lg p-6 text-center">
            <i class="fas fa-arrow-down text-3xl text-red-600 mb-3"></i>
            <h3 class="text-3xl font-bold text-gray-800">Rp 0,00</h3>
            <p class="text-gray-600 mt-2">Total Pendapatan</p>
          </div>

          <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6 text-center">
            <i class="fas fa-arrow-up text-3xl text-blue-600 mb-3"></i>
            <h3 class="text-3xl font-bold text-gray-800">Rp 0,00</h3>
            <p class="text-gray-600 mt-2">Total Belanja</p>
          </div>

          <div class="bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg p-6 text-center">
            <i class="fas fa-plus text-3xl text-pink-600 mb-3"></i>
            <h3 class="text-3xl font-bold text-gray-800">Rp 0,00</h3>
            <p class="text-gray-600 mt-2">Penerimaan Pembiayaan</p>
          </div>

          <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6 text-center">
            <i class="fas fa-minus text-3xl text-green-600 mb-3"></i>
            <h3 class="text-3xl font-bold text-gray-800">Rp 0,00</h3>
            <p class="text-gray-600 mt-2">Pengeluaran Pembiayaan</p>
          </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-md text-center">
              <p class="text-yellow-700 font-semibold">Belum ada data rincian pendapatan.</p>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-md text-center">
              <p class="text-yellow-700 font-semibold">Belum ada data rincian belanja.</p>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-md text-center">
              <p class="text-yellow-700 font-semibold">Belum ada data rincian pembiayaan.</p>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-md text-center">
              <p class="text-yellow-700 font-semibold">Belum ada data realisasi APBDes.</p>
            </div>
          </div>
