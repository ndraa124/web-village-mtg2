  ...
  <div class="container mx-auto px-4">
    <div class="bg-white rounded-lg shadow-xl mb-12 overflow-hidden">
      <div class="bg-gradient-to-r from-red-600 to-red-700 p-8 text-white">
        ...
        <p class="text-center text-white/90">Desa Motoilng Dua</p>
      </div>
      <div class="p-8">
        <blockquote class="text-2xl md:text-3xl font-bold text-center text-gray-800 leading-relaxed italic">
          "Semangat Persaudaraan, Gotong Royong dan Transparan Dalam Mewujudkan Desa Motoling Dua Yang Berbudaya,Mandiri dan Beretika"
        </blockquote>
      ...
      <div class="p-8">
        <div class="space-y-6">
          <div class="flex items-start border-l-4 border-red-600 pl-6 hover:bg-gray-50 py-4 transition">
            ...
            <div>
              <h4 class="font-bold text-gray-800 mb-2">Pemberdayaan SDM, Pemberdayaan SDA</h4>
          ...
          <div class="flex items-start border-l-4 border-blue-600 pl-6 hover:bg-gray-50 py-4 transition">
            ...
            <div>
              <h4 class="font-bold text-gray-800 mb-2">Pemberdayaan Ekionomi Kerakyatan</h4>
              <p class="text-gray-600"></p>
            </div>
          </div>
          ...
          <div class="flex items-start border-l-4 border-green-600 pl-6 hover:bg-gray-50 py-4 transition">
            ...
            <div>
              <h4 class="font-bold text-gray-800 mb-2">Menciptakan Kondisi Masyarakat Desa Motoling Dua yang aman, tertib dan nyaman</h4>
              <p class="text-gray-600"></p>
            </div>
          </div>
          ...
          <div class="flex items-start border-l-4 border-yellow-600 pl-6 hover:bg-gray-50 py-4 transition">
            ...
            <div>
              <h4 class="font-bold text-gray-800 mb-2">Penyelenggaraan Pemerintah yang tertib dan transparan.</h4>
              <p class="text-gray-600"></p>
            </div>
          </div>
          ...
          <div class="flex items-start border-l-4 border-purple-600 pl-6 hover:bg-gray-50 py-4 transition">
            ...
            <div>
              <h4 class="font-bold text-gray-800 mb-2">Pelayanan kepda masyrakat yang Digital, Cepat, tepat tertib dan benar.</h4>
              <p class="text-gray-600"></p>
            </div>
          </div>
          ...
          <div class="flex items-start border-l-4 border-pink-600 pl-6 hover:bg-gray-50 py-4 transition">
            ...
            <div>
              <h4 class="font-bold text-gray-800 mb-2">Pelaksanaan Pembangunan yang berkesinambungan</h4>
              <p class="text-gray-600"></p>
            </div>
          </div>
        </div>
