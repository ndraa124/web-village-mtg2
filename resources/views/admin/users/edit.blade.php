        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="mb-20">
              ...
              <div class="form-group">
                <input type="text" name="nik" class="form-control" id="nik" value="{{ old('nik', $user->nik) }}" placeholder="NIK">
              </div>
              @error('nik')
          ...
          <div class="col-lg-12">
            <div class="d-flex gap-2">
              ...
              <a href="{{ route('admin.users.index') }}" class="btn btn-danger fw-normal text-white">Batal</a>
            </div>
          </div>
        </div>
      </form>
