        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="mb-20">
              ...
              <div class="form-group">
                <input type="text" name="caption" class="form-control" id="caption" value="{{ old('caption') }}" placeholder="Keterangan singkat gambar...">
              </div>
              @error('caption')
                <div class="text-danger small mt-2">
                  {{ $message }}
          ...
          <div class="col-lg-12">
            <div class="d-flex gap-2">
              ...
              <a href="{{ route('admin.content.galleries.index') }}" class="btn btn-danger fw-normal text-white">Batal</a>
            </div>
          </div>
        </div>
      </form>
