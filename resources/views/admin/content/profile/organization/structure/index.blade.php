<ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    <a class="nav-link active" href="#">Struktur Organisasi Pemerintah Desa</a>
  </li>
  <li class="nav-item" role="presentation">
          ...
          <table class="table align-middle">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <img src="{{ $structure->image_url }}" alt="{{ $structure->caption ?? 'Structure Image' }}" style="width: 100px; height: 70px; object-fit: cover; border-radius: 8px;">
                </td>
                <td class="text-body">{{ $structure->caption ?? '-' }}</td>
                <td class="text-body text-center">{{ $structure->created_at->format('d M Y, H:i') }}</td>
                <td>
                  <div class="d-flex justify-content-center" style="gap: 18px;">
                    <a href="{{ route('admin.content.profile.organization.structure.edit', $structure->id) }}" class="bg-transparent p-0 border-0 hover-text-warning" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
