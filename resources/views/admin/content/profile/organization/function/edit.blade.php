...
<div class="row">
  <div class="col-lg-12">
    @if ($errors->any())
      <div class="col-12">
        <div class="alert fs-16 alert-danger alert-dismissible" role="alert">
          Terjadi kesalahan, silakan periksa inputan Anda.
    ...
    <div class="card bg-white p-20 rounded-10 border border-white mb-4">
      <form action="{{ route('admin.content.profile.organization.function-officials.update', $function->id) }}" method="POST">
        @csrf @method('PUT')
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="mb-20">
              ...
              <div class="form-group">
                <input type="text" name="position_name" class="form-control" value="{{ old('position_name', $function->position_name) }}" placeholder="Contoh: Kepala Desa" required>
              </div>
              @error('position_name')
          ...
          <div class="col-lg-6">
            <div class="mb-20">
              ...
              <div class="form-group">
                <input type="text" name="icon_class" class="form-control" value="{{ old('icon_class', $function->icon_class) }}" placeholder="Contoh: fas fa-handshake (Font Awesome)">
          ...
          <div class="col-lg-12">
            <div class="mb-20">
              ...
              <div class="form-group">
                <textarea id="ckeditor-editor" name="description" class="form-control" rows="10">{{ old('description', $function->description) }}</textarea>
              </div>
              @error('description')
                <div class="text-danger small mt-2">{{ $message }}</div>
              @enderror
