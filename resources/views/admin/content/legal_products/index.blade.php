<div class="card bg-white rounded-10 border border-white mb-4">
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 p-20">
    <form action="{{ route('admin.content.legal-product.index') }}" method="GET" class="table-src-form position-relative m-0">
    ...
    <a href="{{ route('admin.content.legal-product.create') }}" class="text-primary fs-16 text-decoration-none">+ Tambah Baru</a>
  </div>
