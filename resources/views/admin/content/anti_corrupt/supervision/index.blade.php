<ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
  ...
  <li class="nav-item" role="presentation">
    <a class="nav-link active" href="#">Pengawasan</a>
  </li>
  <li class="nav-item" role="presentation">
          ...
          <table class="table align-middle">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-body">{{ $supervision->shortContent ?? 'Deskripsi belum diisi' }}</td>
                <td class="text-body text-center">{{ $supervision->created_at->format('d M Y, H:i') }}</td>
                <td>
                  <div class="d-flex justify-content-center" style="gap: 18px;">
                    <a href="{{ route('admin.content.anti.supervision.edit', $supervision->id) }}" class="bg-transparent p-0 border-0 hover-text-warning" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
