            ...
            <td>
              <form action="{{ route('admin.content.slider.destroy', $row->id) }}" method="POST">
                <div class="d-flex justify-content-center" style="gap: 18px;">
                  ...
                  <a href="{{ route('admin.content.slider.show', $row->id) }}" class="bg-transparent p-0 border-0 hover-text-success"
                  ...
                  <a href="{{ route('admin.content.slider.edit', $row->id) }}" class="bg-transparent p-0 border-0 hover-text-warning"
