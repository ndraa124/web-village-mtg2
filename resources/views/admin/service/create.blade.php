        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="mb-20">
              ...
              <div class="form-group">
                <input type="text" id="title" name="title" class="form-control" value="{{ old('title') }}" placeholder="Contoh: Surat Keterangan Usaha">
              </div>
              @error('title')
            ...
            <div class="mb-20">
              ...
              <div class="form-group">
                <input type="text" id="icon_class" name="icon_class" class="form-control" value="{{ old('icon_class') }}" placeholder="Contoh: fas fa-handshake (Font Awesome)">
          ...
          <div class="col-lg-6">
            <div class="mb-20">
              ...
              <div class="form-group">
                <textarea id="description" name="description" class="form-control" rows="3" placeholder="Deskripsi singkat layanan untuk tampilan kartu.">{{ old('description') }}</textarea>
              </div>
              @error('description')
                <div class="text-danger small mt-2">
                  {{ $message }}
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="mb-20">
              ...
              <div class="form-group">
                <textarea id="ckeditor-editor" name="requirements_content" class="form-control" rows="10">{{ old('requirements_content') }}</textarea>
              </div>
