<div class="row">
  <div class="col-lg-12">
    ...
    <div class="card bg-white p-20 rounded-10 border border-white mb-4">
      <form action="{{ route('admin.infographics.resident.job.store') }}" method="POST">
        @csrf
          ...
          @if ($jobs->isEmpty())
            <div class="col-12">
              <div class="alert alert-warning fs-16" role="alert">
                Semua data pekerjaan sudah ditambahkan.
              </div>
            </div>
          @else
            <div class="col-lg-6">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="d-flex gap-2">
              ...
              @endif
              <a href="{{ route('admin.infographics.resident.job.index') }}" class="btn btn-danger fw-normal text-white">Batal</a>
            </div>
          </div>
        </div>
      </form>
