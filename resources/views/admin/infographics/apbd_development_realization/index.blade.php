<ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
  ...
  <li class="nav-item" role="presentation">
    <a class="nav-link active" href="#">Realisasi Pembangunan</a>
  </li>
</ul>
  ...
  <div class="default-table-area mx-minus-1 mb-2">
    <div class="table-responsive">
      <table class="table align-middle">
        ...
        <tbody>
          @forelse ($apbdRealizations as $row)
            <tr>
              <td class="text-body text-center">{{ $loop->iteration + $apbdRealizations->firstItem() - 1 }}</td>
