        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="mb-20">
              ...
              <div class="form-group">
                <input type="number" name="year" class="form-control" value="{{ old('year', $stunting->year) }}" placeholder="Contoh: 2024" min="1900" max="9999">
              </div>
              @error('year')
          ...
          <div class="col-lg-6">
            <div class="mb-20">
              ...
              <div class="form-group">
                <input type="number" name="total" class="form-control" value="{{ old('total', $stunting->total) }}" placeholder="0" min="0">
              </div>
              @error('total')
                <div class="text-danger small mt-2">
                  {{ $message }}
            ...
            <div class="mb-20">
              ...
              <div class="form-group">
                <select name="is_active" class="form-select form-control" aria-label="Status">
                  <option value="1" {{ old('is_active', $stunting->is_active) == 1 ? 'selected' : '' }}>Aktif</option>
                  <option value="0" {{ old('is_active', $stunting->is_active) == 0 ? 'selected' : '' }}>Tidak Aktif</option>
                </select>
              </div>
              @error('is_active')
                <div class="text-danger small mt-2">
