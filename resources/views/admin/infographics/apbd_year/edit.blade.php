<div class="row">
  <div class="col-lg-12">
    ...
    <div class="card bg-white p-20 rounded-10 border border-white mb-4">
      <form action="{{ route('infographics.apbd.apbd_year.update', $apbdYear->id) }}" method="POST">
        @csrf @method('PUT')
          ...
          <div class="col-lg-6">
            <div class="mb-20">
              ...
              <div class="form-group">
                <input type="number" name="year" class="form-control" value="{{ old('year', $apbdYear->year) }}" placeholder="Contoh: 2024" min="1900" max="9999">
              </div>
              @error('year')
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="d-flex gap-2">
              ...
              <a href="{{ route('infographics.apbd.apbd_year.index') }}" class="btn btn-danger fw-normal text-white">Batal</a>
            </div>
          </div>
        </div>
      </form>
