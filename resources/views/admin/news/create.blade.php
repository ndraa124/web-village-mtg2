        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="mb-20">
              ...
              <div class="form-group">
                <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="Masukkan judul berita...">
              </div>
              @error('title')
          ...
          <div class="col-lg-12">
            <div class="mb-20">
              ...
              <div class="form-group">
                <textarea id="ckeditor-editor" name="content" class="form-control" rows="10" placeholder="Masukkan konten berita...">{{ old('content') }}</textarea>
              </div>
              @error('content')
              <div class="text-danger small mt-2">
                {{ $message }}
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="d-flex gap-2">
              ...
              <a href="{{ route('manage-news.index') }}" class="btn btn-danger fw-normal text-white">Batal</a>
            </div>
          </div>
        </div>
      </form>
