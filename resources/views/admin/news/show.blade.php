  ...
  <div class="col-lg-12">
    <div class="card bg-white rounded-10 border border-white mb-4">
      ...
      <div class="border-top p-20">
        <a href="{{ route('manage-news.index') }}" class="btn btn-danger fw-normal text-white">Kembali</a>
        <a href="{{ route('manage-news.edit', $news->id) }}" class="btn btn-warning fw-normal text-white">Edit</a>
      </div>
